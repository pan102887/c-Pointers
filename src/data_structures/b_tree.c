...
CP_STATIC_INLINE b_tree_node *node_stack_pop(b_tree_node_stack **stack);
CP_STATIC_INLINE node_stack_push_result node_stack_push(b_tree_node_stack **stack, b_tree_node *node);
CP_STATIC_INLINE void node_stack_free(b_tree_node_stack **stack);

CP_STATIC_INLINE void node_height_adjust(b_tree_node_stack **stack);

CP_STATIC_INLINE size_t b_tree_node_height(b_tree_node *node);
CP_STATIC_INLINE b_tree_node *alloc_b_tree_node(int key, void *value);
CP_STATIC_INLINE void b_tree_node_insert(b_tree_node **root, int key, void *value);
CP_STATIC_INLINE void b_tree_subtree_free(b_tree_node **root);
CP_STATIC_INLINE void b_tree_node_delete(b_tree_node **root, int key);
CP_STATIC_INLINE void b_tree_node_free(b_tree_node **node, b_tree_node_stack **stack);
CP_STATIC_INLINE void node_free(b_tree_node **node);
CP_STATIC_INLINE void b_tree_node_print(b_tree_node *tree);
...
CP_STATIC_INLINE void node_height_adjust(b_tree_node_stack **stack)
{
    ...
    while ((currnt = node_stack_pop(stack)) != NULL)
    {
        ...
        currnt->height = CP_B_TREE_MAX(left_height, right_height) + 1;
    }
}
...
CP_STATIC_INLINE void stack_test(void)
{
    b_tree_node_stack *stack = NULL;
...
CP_STATIC_INLINE void tree_height_test(void)
{
...
CP_STATIC_INLINE void tree_height_test2(void)
{
    b_tree *tree = b_tree_new();
